...
from src.services.report_llm_conclusion_service import generate_report_llm_conclusion
...
XBRL_DICTIONARY_PATH = Path(__file__).with_name("xbrl_data_dictionary_all.json")
