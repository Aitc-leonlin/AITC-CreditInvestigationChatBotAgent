...
PERMISSIONS: tuple[PermissionDefinition, ...] = (
    ...
    _permission("organization-scope.view", "組織資料權限-檢視", "檢視組織、職位與資料權限規則。", "VIEW", "group-org-scope", "ORG_SCOPE", "組織資料權限"),
    _permission("organization-scope.add", "組織資料權限-新增", "新增組織、職位與資料權限規則。", "ADD", "group-org-scope", "ORG_SCOPE", "組織資料權限"),
    _permission("organization-scope.edit", "組織資料權限-編輯", "編輯組織、職位與資料權限規則。", "EDIT", "group-org-scope", "ORG_SCOPE", "組織資料權限"),
    _permission("organization-scope.delete", "組織資料權限-刪除", "刪除組織、職位與資料權限規則。", "DELETE", "group-org-scope", "ORG_SCOPE", "組織資料權限"),
